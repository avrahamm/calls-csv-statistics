...
/**
 * Create calls_staging table for parallel processing
 */
final class Version20250526000000 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create calls_staging table for parallel processing';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE calls_staging (
